...
public class ValidateUserInfo extends AsyncTask<String, Integer, String>
{
    ...
    protected String doInBackground(String... Args) {
        ...
        try
        {
            ...
            // Build URI
            URIBuilder builder = new URIBuilder("http://10.0.2.2:8080/TripShareProject/UserInfoValidation");//("http://tripshare-env.cqpn2tvmsr.us-east-1.elasticbeanstalk.com/UserInfoValidation");
