...
public class SendCommentToAddToPostInDB extends AsyncTask<String, Integer, String>
{
    ...
    protected String doInBackground(String... Args) {
        ...
        try {
            ...
            URIBuilder builder = new URIBuilder("http://tripshare-env.cqpn2tvmsr.us-east-1.elasticbeanstalk.com/CommentServlet");//("http://tripshare-env.cqpn2tvmsr.us-east-1.elasticbeanstalk.com/CommentServlet");
            //URIBuilder builder = new URIBuilder("http://10.0.2.2:8080/TripShareProject/CommentServlet");
