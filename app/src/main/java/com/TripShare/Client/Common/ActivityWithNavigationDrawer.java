...
public class ActivityWithNavigationDrawer extends AppCompatActivity {
    ...
    public void initializeDrawerLayout() {
        ...
        list.add(new DrawerItem("Home", getDrawable(R.drawable.ic_image_black_24dp)));
        list.add(new DrawerItem("Profile", getDrawable(R.drawable.ic_image_black_24dp)));
        list.add(new DrawerItem("Create new route", getDrawable(R.drawable.ic_image_black_24dp)));
        list.add(new DrawerItem("Create new post", getDrawable(R.drawable.ic_image_black_24dp)));
        list.add(new DrawerItem("Settings", getDrawable(R.drawable.ic_image_black_24dp)));
        list.add(new DrawerItem("Logout", getDrawable(R.drawable.ic_image_black_24dp)));
        list.add(new DrawerItem("About", getDrawable(R.drawable.ic_image_black_24dp)));
